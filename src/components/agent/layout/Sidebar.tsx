  ...
  return (
    <div className={`adm-sidebar${minimized ? ' adm-sidebar--min' : ''}`}>
      ...
      <div className="adm-nav-sec">Patients</div>
        <Item to="/agent/patients/PatientsList" minimized={minimized} icon={
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
              <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>
            </svg>
          } label ="Liste des patients" count="" countCls="adm-nb-blue" fontSize={13}/> 
      ...
      } label="Gestion admissions" count="" countCls="adm-nb-red" fontSize={13} />
      <Item to="/agent/admissions/AdmissionForm" minimized={minimized} icon={
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
          <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
        </svg>
      } label="Nouvelle admission" fontSize={13} />
      <Item to="/agent/admissions/SortieForm" minimized={minimized} icon={
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
          <circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/>
        </svg>
      } label="Nouvelle sortie" fontSize={13}/>
      ...
      } label="Nouveau RDV" count="" countCls="adm-nb-green" fontSize={13} />
      <Item to="/agent/appointments/MedecinList" minimized={minimized} icon={
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
          <circle cx="12" cy="12" r="3"/>
          <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/>
        </svg>
      } label="Liste de Médecin-RDV" fontSize={13} />
        ...
        */}
        ...
        <Item to="/agent/billing/InvoiceList" minimized={minimized} icon={
          ...
          } label ="Factures" count="" countCls="adm-nb-blue" fontSize={13}/> 
        ...
        <Item to="/agent/reports/Reports" minimized={minimized} icon={
          ...
          } label ="Statistiques" count="" countCls="adm-nb-blue" fontSize={13}/> 
